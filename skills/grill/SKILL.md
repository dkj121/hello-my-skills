...
When suggesting follow-on work:

- Describe what would be valuable next, not which specific skill to invoke
- If the user wants to proceed with documentation, they can activate to-docs
- If the user wants to implement, they can activate implement
- Let the user choose the path — this skill concludes with recommendations, not forced transitions
