...
- If your harness provides a Skill tool, invoke it with the skill's name.
- Otherwise, read the target skill's SKILL.md and follow it directly:
  - Bundled skills live in sibling directories: `../<skill-name>/SKILL.md`.
  - Project-level skills live in the target project at `.agents/skills/<skill-name>/SKILL.md` (mirrored at `.claude/skills/<skill-name>/SKILL.md`).
